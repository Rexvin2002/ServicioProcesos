...
public class GameOverDialog extends javax.swing.JDialog {
    ...
    public GameOverDialog(JFrameFight parent, boolean modal) {
        ...
        try {
            ...
            ImageIcon imageIcon = new ImageIcon(GameManager.gameover);
    ...
    private void initComponents() {
        ...
        jLabelImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/gameover.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            GameOverDialog dialog = new GameOverDialog((JFrameFight) new javax.swing.JFrame(), true);
