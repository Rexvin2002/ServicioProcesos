...
public class ChangeWord {
    ...
    public static void main(String[] args) {
        ...
        while (emparejador.find()) {
            ...
            int index = -1;
            switch (matchedWord) {
                case "gato" -> index = 0; // Reemplazar con "perro"
                case "gatos" -> index = 1; // Reemplazar con "perros"
                case "felinos" -> index = 1; // Reemplazar con "perros"
                case "perro" -> index = 2; // Reemplazar con "gato"
                case "perros" -> index = 3; // Reemplazar con "gatos"
                case "caninos" -> index = 3; // Reemplazar con "gatos"
            }
