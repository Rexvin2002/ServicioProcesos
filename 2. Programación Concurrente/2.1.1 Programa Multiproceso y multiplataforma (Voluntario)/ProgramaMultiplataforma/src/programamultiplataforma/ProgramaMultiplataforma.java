            ...
            do {
                ...
                switch (opcion) {
                    ...
                    case 2 -> {
                        ...
                        try {
                            FileRenamer.main(new String[]{"C:\\Users\\kgv17\\Desktop\\CarpetaEjemplo", ".*\\.txt", "renamed_file"});
                        } catch (Exception e) {
                    ...
                    case 3 -> {
                        ...
                        try {
                            FileRenamer2.main(new String[]{"C:\\Users\\kgv17\\Desktop\\CarpetaEjemplo", ".*\\.txt", "renamed_file"});
                        } catch (Exception e) {
