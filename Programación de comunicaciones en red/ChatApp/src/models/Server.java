...
public class Server {
    ...
    private final List<ClientHandler> clients = new ArrayList<>();  // Lista de clientes conectados
    ...
    public void close() {
        try {
            ...
            System.out.println("Error al encontrar el socket: " + e.getMessage());
        }
    }

    /**
     * Envío de mensajes a todos los clientes
     */
    ...
    /**
     * Envío de archivos a todos los clientes
     */
    ...
    private class ClientHandler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println("Error al mostrar el mensaje del cliente o al enviar el mensaje a todos los clientes: " + e.getMessage());
            } finally {
                try {
                    ...
                    System.out.println("Error al cerrar la conexión o al eliminar el escritor del cliente: " + e.getMessage());
                }
            }
        }
